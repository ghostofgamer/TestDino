...
public class PuzzleHandler : MonoBehaviour
{
    ...
    [SerializeField] private GameObject completePuzzle;
    ...
    public float CorrectPositionAccuracy
    {
        get => correctPositionAccuracy;
    }

    public float AnimationAccuracy
    {
        get => animationAccuracy;
    }

    public float SmoothDragMultiplier
    {
        get => smoothDragMultiplier;
    }

    public float MinSmoothAnimationMultiplier
    {
        get => minSmoothAnimationMultiplier;
    }

    public float MaxSmoothAnimationMultiplier
    {
        get => maxSmoothAnimationMultiplier;
    }

    public float ShadowAnimationDuration
    {
        get => shadowAnimationDuration;
    }
